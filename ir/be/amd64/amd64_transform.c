...
static void perform_address_matching(const ir_node *load, int *arity,
                        ...
                        match_flags_t flags)
{
	...
	if (use_immediate
		...
		perform_address_matching(load, &(args->arity), args->in, addr,
				                 &(args->reqs));
                              ...
                              match_flags_t flags)
{
	...
	if (use_am) {
		...
		perform_address_matching(load, &arity, in, &addr, &reqs);
