...
int main(void)
{
	...
	ir_mode *const new_modes[] = {
		new_int_mode("uint8",  irma_twos_complement, 8,  false, 0),
		new_int_mode("uint16", irma_twos_complement, 16, false, 0),
		new_int_mode("uint24", irma_twos_complement, 24, false, 0),
		new_int_mode("uint32", irma_twos_complement, 32, false, 0),
		new_int_mode("uint64", irma_twos_complement, 64, false, 0),
		new_int_mode("uint6",  irma_twos_complement, 6,  false, 0),
		new_int_mode("uint13", irma_twos_complement, 13, false, 0),

		new_int_mode("int8",  irma_twos_complement, 8,  true, 0),
		new_int_mode("int16", irma_twos_complement, 16, true, 0),
		new_int_mode("int24", irma_twos_complement, 24, true, 0),
		new_int_mode("int32", irma_twos_complement, 32, true, 0),
		new_int_mode("int64", irma_twos_complement, 64, true, 0),
